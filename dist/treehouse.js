...
/***/ function(module, exports, __webpack_require__) {
	...
	// AMD
	if (global.define && __webpack_require__(165)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dirty_tracker = __webpack_require__(7);
	...
	var App = function App() {
	  ...
	  var _app = this;
	  this.Component = (function (_ComponentBaseClass) {
	    _inherits(Component, _ComponentBaseClass);
	  ...
	  this.actions = new _actions2['default'](this.tree);

	  this.dirtyTracker = new _dirty_tracker2['default']();

	  this.tree.onChange(function (_ref) {
	    var path = _ref.path;

	    _app.dirtyTracker.markBranchDirty(path[0]);
	  });
	  this.tree.onCommit(function () {
	    _app.dirtyTracker.eachDirtyComponent(function (c) {
	      return c.syncWithTree();
	    });
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _event_emitter = __webpack_require__(5);
	...
	var Tree = (function () {
	  function Tree() {
	    ...
	    this.eventEmitter = new _event_emitter2['default']();
	  }
	  ...
	  _createClass(Tree, [{
	    ...
	    key: 'setData',
	    value: function setData(data, changePath) {
	      this.data = data;
	    ...
	    value: function at() {
	      ...
	      return new _cursor2['default'](this, path);
	    }
	  }, {
	    key: 'get',
	    value: function get() {
	      return this.at.apply(this, arguments).get();
	    }
	  }, {
	    key: 'p',
	    value: function p() {
	...
	var Cursor = (function () {
	  ...
	  _createClass(Cursor, [{
	    ...
	    value: function at() {
	      ...
	      return new this.constructor(this.tree, this.path.concat(path));
	    }
	  }, {
	    key: 'get',
	    value: function get() {
	    ...
	    value: function map(callback) {
	      ...
	      return this.get().map(function (item, i) {
	        return callback(_this.at(i), i);
	      });
	    }
	  }, {
	    key: 'equals',
	    ...
	    value: function set() {
	      ...
	      if (typeof valueArg === 'function') {
	        var currentValue = this.tree.getData().getIn(pathToAttr);
	      ...
	      value = _immutable2['default'].fromJS(value); // ensure it's immutable
	      this.tree.setData(this.tree.getData().updateIn(pathToAttr, function () {
	        return value;
	      }), pathToAttr);
...
/***/ function(module, exports) {
	...
	var Subscription = (function () {
	  function Subscription(eventEmitter, eventName, callback) {
	...
	var EventEmitter = (function () {
	  ...
	  _createClass(EventEmitter, [{
	    ...
	    value: function off(eventName, callback) {
	      var channel = this.channel(eventName),
	    ...
	    value: function emit(eventName, payload) {
	      this.channel(eventName).forEach(function (callback) {
...
/***/ function(module, exports) {
	...
	var Actions = (function () {
	  ...
	  _createClass(Actions, [{
	    key: "register",
	    value: function register(actions) {
	      Object.assign(this.actions, actions);
	    }
	  }, {
	    key: "do",
	    value: function _do(name) {
...
/***/ function(module, exports) {
	...
	var DirtyTracker = (function () {
	  ...
	  _createClass(DirtyTracker, [{
	    ...
	    key: "register",
	    value: function register(component, branches) {
	      var _this = this;

	      this.all.add(component);
	      branches.forEach(function (b) {
	        return _this.branch(b).add(component);
	      });
	    }
	  }, {
	    key: "unregister",
	    value: function unregister(component, branches) {
	      var _this2 = this;

	      this.all["delete"](component);
	      this.dirty["delete"](component);
	      branches.forEach(function (b) {
	        return _this2.branch(b)["delete"](component);
	      });
	    }
	  }, {
	    key: "markBranchDirty",
	    value: function markBranchDirty(branch) {
	      ...
	      var components = branch ? this.branch(branch) : this.all;
	    ...
	    value: function markComponentClean(component) {
	      this.dirty["delete"](component);
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var areEqual = function areEqual(var1, var2) {
	  if (var1.equals) {
	...
	var elementsAreEqual = function elementsAreEqual(obj1, obj2) {
	  var key = undefined;
	  for (key in obj1) {
	...
	// "a.b.c" -> "a" or ["a", "b", "c" ] -> "a"
	var branchFromPath = function branchFromPath(path) {
	...
	var branchesFrom = function branchesFrom(cursors) {
	  var key = undefined,
	      branches = [];
	  for (key in cursors) {
	...
	var resolveCursors = function resolveCursors(cursors) {
	  var key = undefined,
	      data = {};
	  for (key in cursors) {
	...
	var Component = (function (_React$Component) {
	  ...
	  _createClass(Component, [{
	    ...
	    value: function shouldComponentUpdate(nextProps, nextState) {
	      ...
	      return !elementsAreEqual(this.state, nextState) || !elementsAreEqual(this.props, nextProps);
	    }
	  }, {
